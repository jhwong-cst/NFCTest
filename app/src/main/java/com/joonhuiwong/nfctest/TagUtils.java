...
public class TagUtils {
    ...
    public static String detectTagSerialNumber(Tag tag) {
        byte[] id = tag.getId();
        return CommonUtils.toReversedHex(id);
    }
    ...
    public static String detectTagData(Tag tag) {
        ...
        byte[] id = tag.getId();
        sb.append("ID (hex): ").append(CommonUtils.toHex(id)).append('\n');
        sb.append("ID (reversed hex): ").append(CommonUtils.toReversedHex(id)).append('\n');
        sb.append("ID (dec): ").append(CommonUtils.toDec(id)).append('\n');
        sb.append("ID (reversed dec): ").append(CommonUtils.toReversedDec(id)).append('\n');
